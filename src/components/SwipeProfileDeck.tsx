...
export const SwipeProfileDeck: React.FC<SwipeProfileDeckProps> = ({ profiles }) => {
  ...
  const handlePointerMove = (e: React.PointerEvent) => {
    ...
    const deltaY = (e.clientY - startPosRef.current.y) * 0.2; // constrain vertical drift
        ...
        {isDeckFinished ? (
          ...
          <div className="w-full h-full glass-card rounded-3xl p-8 flex flex-col items-center justify-center text-center border border-slate-200/80 bg-white/95 shadow-xl animate-in zoom-in-95 duration-300">
            ...
            <p className="text-xs sm:text-sm text-slate-500 max-w-xs mb-6 leading-relaxed">
              Explore our full directory below with targeted country, category, and skill filters.
            </p>
          ...
          visibleCards.map((profile, i) => {
            ...
            // Compute dynamic card transformation based on stack position and drag state
            let transform = '';
            let zIndex = 30 - i * 10;
            ...
            return (
              ...
              >
                ...
                {/* Swipe Direction Hint Overlays (shown during active drag) */}
                ...
                {/* Bottom Gradient Glass Information Overlay */}
